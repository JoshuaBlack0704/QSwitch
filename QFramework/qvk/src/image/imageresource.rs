...
impl<I:InstanceSource + Clone, D:DeviceStore + InstanceSupplier<I> + Clone, Img:ImageStore + InternalDeviceStore<D> + Clone> ImageResource<I,D,Img>{
...
impl<I:InstanceSource, D:DeviceStore + InstanceSupplier<I> + Clone, Img:ImageStore + InternalDeviceStore<D>> ImageSubresourceStore for Arc<ImageResource<I,D,Img>>{
...
impl<I:InstanceSource, D:DeviceStore + InstanceSupplier<I>, Img:ImageStore + InternalDeviceStore<D>> ImageCopyFactory for Arc<ImageResource<I,D,Img>>{
    fn extent(&self) -> vk::Extent3D {
        self.extent
    }
...
impl<I:InstanceSource, D:DeviceStore + InstanceSupplier<I>, Img:ImageStore + InternalDeviceStore<D>> InternalImageStore<Img> for Arc<ImageResource<I,D,Img>>{
